    ...
    : wxFrame(nullptr, wxID_ANY, title, wxDefaultPosition, wxDefaultSize)
{
    ...
    auto sub_sizer = new wxBoxSizer(wxHORIZONTAL);
    auto panel = new wxPanel(this,wxID_ANY,wxDefaultPosition, wxSize(250,250));
    panel->SetBackgroundColour(wxColor(210,100,100));


    // fuck yea dude i kinda get how the library works.
    ...
    if (wxGLCanvas::IsDisplaySupported(vAttrs))
    {
        ...
        canvas2 = new OpenGLCanvas(this, vAttrs);
        // for minimum canvas size
        openGLCanvas->SetMinSize(FromDIP(wxSize(300, 300)));
        canvas2->SetMinSize(FromDIP(wxSize(250,250)));
        sizer->Add(openGLCanvas, 1.25, wxEXPAND);
        sub_sizer->Add(canvas2,1.25,wxEXPAND | wxALL, 5);
        sub_sizer->Add(panel,1, wxEXPAND | wxALL, 5);
    }
    ...
    sizer->Add(sub_sizer, 1, wxEXPAND | wxALL, 15);
    ...
    colorButton->Bind(wxEVT_BUTTON, [this](wxCommandEvent &event)
                      {
                          ...
                          colorData.SetColour(this->canvas2->triangleColor);
                          ...
                          if (dialog.ShowModal() == wxID_OK)
                          {
                              ...
                              canvas2->triangleColor = dialog.GetColourData().GetColour();
                              canvas2->Refresh();
                          } });
}
